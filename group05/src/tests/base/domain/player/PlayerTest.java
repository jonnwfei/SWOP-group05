...
class PlayerTest {
    ...
    class StrategyDelegationTests {
        ...
        void delegatesChooseCard() {
            ...
            when(mockStrategy.chooseCardToPlay(defaultPlayerId, anyList(), eq(Suit.HEARTS))).thenReturn(expected);

            Card result = player.chooseCard(Suit.HEARTS);

            assertEquals(expected, result);
            verify(mockStrategy).chooseCardToPlay(defaultPlayerId, anyList(), eq(Suit.HEARTS));
        }
