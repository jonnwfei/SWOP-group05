...
/**
 * A Data Transfer Object (DTO) that captures the complete state of a bidding turn.
 ...
 * @param currentHighestBidType The strongest bid placed so far in the current bidding phase
 * @param bidTypes              An array of all possible {@link BidType} values.
 * @param playerHand           The 13 cards currently held by the bidding player.
 */
