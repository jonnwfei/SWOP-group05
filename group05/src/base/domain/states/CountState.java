 ...
 * state emits a SaveDescriptionResult and, once the follow-up
 * TextCommand arrives, simply resumes the scoreboard.
 *
 * @author Stan Kestens
 * @since 01/03/2026
 */
    ...
    private StateStep handleNumberInput(int value) {
        ...
        return switch (value) {
            ...
            case 3 -> {
                ...
                yield StateStep.stay(new SaveDescriptionResult(SaveMode.COUNT));
            }
